...
async function runTestAsync(config, options) {
    ...
    if (app.preset === 'detox') {
        ...
        const preset = new DetoxTemplate_1.default(app, appName, options.platform, options.configFile);
...
exports.default = (program) => {
    registerCommand_1.registerCommand(program, 'run-test', runTestAsync).option('-t, --test [string]', 'Name of the test case to run.');
};
