...
const DetoxTemplate_1 = __importDefault(require("../presets/DetoxTemplate"));
...
async function createProjectAsync(config, options) {
    ...
    if (app.preset === 'detox') {
        ...
        const preset = new DetoxTemplate_1.default(app, options.app, options.platform, options.configFile);
...
exports.default = (program) => {
    registerCommand_1.registerCommand(program, 'create-project', createProjectAsync).option('-a, --app [string]', 'Name of the application to create.');
};
